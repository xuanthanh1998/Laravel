...
class TheloaiPolicy
{
    ...
    public function view(User $user, TheLoaiModel $theloai)
    {
        return (
            ...
            ($user && (
                ...
                || $user->hasPermission('admin.theloai.danhsach')
            ))
        );
    }
    ...
    {
        return ($user->id == $theloai->user_id || $user->hasPermission('admin.theloai.them'));
    }
    ...
    {
        return ($user->id == $theloai->user_id || $user->hasPermission('delete_theloai'));
    }
    ...
    {
        return ($user->id == $theloai->user_id || $user->hasPermission('restore_post'));
    }
    ...
    {
        return ($user->id == $theloai->user_id || $user->hasPermission('force_delete_theloai'));
    }
}
