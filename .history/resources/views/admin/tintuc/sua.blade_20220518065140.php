...
<div id="page-wrapper">
            <div class="container-fluid">
                <div class="row">
                    ...
                    @endif
                        <form action="admin/tintuc/sua" enctype="multipart/form-data" method="POST">
                        <input type="hidden" name="_token" value="{{csrf_token()}}" />
                            ...
                            <div class="form-group">
                                ...
                                <input class="form-control" name="TieuDeKhongDau" placeholder="Please Enter Category Name" />
                            </div>
