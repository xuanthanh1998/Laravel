                ...
                <div class="row">
                    ...
                    @endif
                        ...
                        <input type="hidden" name="_token" value="{{csrf_token()}}" />
                            ...
                            <div class="form-group">
                                <label>Tóm Tắt</label>
                                <textarea id="demo" class="ckeditor" rows="3" name="TomTat" value="{{$tintuc->TomTat}}" ></textarea>
                            </div>
                            <div class="form-group">
                                <label>Nội Dung</label>
                                <textarea id="demo" class="ckeditor" rows="3" name="NoiDung" value="{{$tintuc->NoiDung}}" ></textarea>
                            </div>
